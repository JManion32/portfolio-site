                ...
                <div className="text-content">
                    ...
                    <div id="text-body">
                        ...
                        <div className={`${readMore ? '' : 'hide-read-more-container'}`}>
                            ...
                            <h2>Secretary</h2>
                            <p>
                                As Secretary, I handle the administrative operations that keep our chapter running
                                smoothly. This role has taught me the importance of being consistently good, rather than
                                occasionally great. I strive to stay on top of my duties so I can be there to assist
                                other officers, and enable them to reach their full potential.
                            </p>
                            <p>
                                One of the more front-facing responsibilities I have is managing our weekly house
                                meetings. Before each meeting, I email a reminder to the brotherhood, then prepare the
                                slideshow, officer agenda, and meeting minutes. I take attendance at the start, record
                                the minutes during the meeting, finalize them afterward, and send them out promptly.
                                This workflow was intimidating at first, but I have come to enjoy it. I see it as my
                                duty to write the history of our chapter, and consider it a great honor to do so.
                            </p>
                            <p>
                                Other duties include managing the fraternity’s official roster, preparing bid packets
                                for new members, and maintaining the Google Calendar, mailing lists, mailboxes, and
                                Google Drive.
                            </p>
                            <hr />
                            ...
                            <p>
                                ...
                                responsibilities are similar to that of the secretary's, but I am now fully focused on
                                our recruitment efforts, rather than fraternity operations as a whole.
                            </p>
                            <hr />
                            <h2>Webmaster</h2>
                            <p>
                                In recent years, the Webmaster role has been neglected, leaving the site outdated and
                                lacking relevant information. I have worked to bring everything up to date, and
                                establish a system to prevent this from happening again. Before I transition out of the
                                role, I intend to create a document that will give the inheritor everything necessary to
                                succeed.
                            </p>
                            <p>
                                My ongoing priority is repopulating the site with new event posts, chapter news, and
                                brotherhood achievements. Beyond this, I aim to add a gallery page showcasing the
                                thousands of digitized photos from our archives as well as a dedicated history page
                                celebrating our chapter’s legacy. My goal is to preserve our story and make it easily
                                accessible to all brothers—past, present, and future.
                            </p>
                            <hr />
                            <h2>Philanthropy</h2>
                            <p>
                                Philanthropy is closely tied with the extensive history of our chapter. At the center of
                                this tradition is our semesterly food drive, an initiative I’ve been honored to
                                participate in.
                            </p>
                            <div id="content-img-container">
                            ...
                            <div id="content-img-container">
                                ...
                                <p>
                                    Fall 2024 Food Drive results (an incredible 3,169 pounds of donations!). This photo
                                    was taken in the room that the brothers are standing in front of 30 years prior in
                                    the previous image, a testament to our longstanding commitment to philanthropy.
                                </p>
                            </div>
                            <p>
                            ...
                            <p>
                                Our chapter participates in a number of other initiatives such as volunteering at Hope
                                7, a local community center. We also hold events such as "Bowls on Sunset" and "Phat
                                Sandos", late-night fundraisers where we cook, package, and deliver food to people on
                                campus, with all proceeds going to charity.
                            </p>
                            <hr />
                            <h2>Reflection</h2>
                            <p>
