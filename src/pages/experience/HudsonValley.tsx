                ...
                main={
                    <>
                        ...
                        <p>
                            ...
                            programming is a skill to be continually developed, like leveling up in a video game. This
                            along with many other courses I was taking were completely online. While I enjoyed the
                            material, I struggled to stay disciplined enough to maximize my learning. Despite my lack of
                            "leveling up", I was excited for what lied ahead, and determined to change my habits.
                        </p>
                        <h3>Programming & Data Logic II</h3>
                        <p>
                            Like Python Programming, HVCC's Data Structures course was fully online, but the assignments
                            were far more complex. Each weekend I stayed up late struggling to make progress, paying the
                            price for not taking the prerequisite seriously. I was putting in the work, but I struggling
                            with the assignments. Thankfully, my dad would spend time with me, helping me understand the
                            material and reason about assignments. I am beyond grateful for his support. Without it, I
                            probably would have given up.
                        </p>
                        <p>
                            Midway through the semester, things began to come together. Each week introduced new core
                            concepts like data structures, generics, recursion, exception handling, inheritance,
                            abstraction, encapsulation, and polymorphism. My favorite, however, was JavaFX, which gave
                            me my first (and certainly not my last) taste of front-end development. By the end of the
                        ...
                        <ul>
                            ...
                            <li>
                                <b>Calculus II:</b> Often touted as the hardest course at HVCC, I was apprehensive going
                                into it, especially with my struggles in Calculus I. Despite this, I was able to achieve
                                a B, a result I was quite proud of.
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                It had nothing to do with CS, but remains as one of the best courses I've ever taken.
                            </li>
                            <li>
                        ...
                        <p>
                            ...
                            academic journey at <a onClick={() => navigateTop('/experience/rensselaer')}>RPI</a>. During
                            ...
                            my study habits, developed academic discipline, and leveled up my skills. As great as my
                            time at <a onClick={() => navigateTop('/experience/rensselaer')}>RPI</a> has been, I
