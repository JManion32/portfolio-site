          ...
          <div id="text-body">
            ...
            <div className={`${readMore ? '' : 'hide-read-more-container'}`}>
              ...
              <p>
                ...
                and commuting from home all while trying to keep up with the rigor of my courses. I took 4 courses totaling 16 credits. They were: Physics I, Multivariable Calculus, Writing 
