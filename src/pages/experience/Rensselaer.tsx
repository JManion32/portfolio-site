    ...
    return (
        <>
            <div className="page">
                <div className="text-content">
                    ...
                    <div id="text-body">
                        ...
                        <div className={`${readMore ? '' : 'hide-read-more-container'}`}>
                            ...
                            <h2>Fall 2024</h2>
                            <p>
                                Transferring from community college to RPI was a massive adjustment. My first semester
                                was exciting, but stressful. I was finding my footing on campus, rushing{' '}
                                <a onClick={() => navigateTop('/experience/lambdachi')}>Lambda Chi Alpha</a>, and
                                commuting from home all while trying to keep up with the rigor of my courses. I took 4
                                courses totaling 16 credits. They were: Physics I, Multivariable Calculus, Writing for
                                Technical Communication, and the most impactful of all:
                            </p>
                            <h3>Data Structures</h3>
                            <p>
                                This course is known for being among the most challenging in the CS curriculum, commonly
                                referred to as a "weed-out course". Featuring 10 homework assignments, weekly labs, and
                                4 exams, it was far more involved than any academic work I had ever done previously.
                                Despite the reputation, I approached this course with excitement and confidence. I
                                already had experience with the material from{' '}
                                <a onClick={() => navigateTop('/experience/HudsonValley')}>Submitty</a>, and I was
                                finally going to write large-scale coding projects for school!
                            </p>
                            <p>
                                Reality hit by the second homework, when I failed to complete the assignment. From there
                                on, I had my work cut out for me. I dug as deep as I could, practically living in the
                                library every single day. Even then, I still felt behind. <i>It was humbling</i>, but it
                                was all worth it. Pressure makes diamonds and I came out as a 10x better programmer than
                                I was going in. During the subsequent winter break, I examined a ~3,000 line project I
                                created the year prior, and was able to refactor it down to ~1,000 lines without
                                changing any functionality!
                            </p>
                            <hr />
                            <h2>Spring 2025</h2>
                            <p>
                                With my “Welcome to RPI” semester behind me, I was ready for round two. Once again, I
                                took 4 courses totaling 16 credits: Linear Algebra, Introduction to Algorithms,
                                Principles of Software (whose website I would later{' '}
                            ...
                            <p>
                                What better way to follow up Data Structures than with an algorithms course? Topics
                                included divide-and-conquer, graph decompositions, paths, greedy algorithms, dynamic
                                programming, linear programming, and NP-complete problems. This paired with ds has
                                equipped me with the skills and confidence necessary to think through complex problems,
                                and perform in technical interviews.
                            </p>
                            <hr />
                            <h2>Fall 2025</h2>
                            <p>
                            ...
                            <p>
                                ...
                                <a onClick={() => navigateTop('/projects/Submitty')}>Submitty</a>. Now, I am proficient.
                                The material included relational algebra, normal forms, ER diagrams, SQL, PGSQL,
                                optimization, and more. I received an A in the course, a testament to my newfound
                                proficiency with the material. A special thank you to Professor{' '}
                            ...
                            <p>
                                ...
                                project lead. It will be a busy semester, but I am super excited for all 4 of these
                                courses, and the journey that lies beyond them!
                            </p>
                            <hr />
                            <h2>Reflection</h2>
                            <p>RPI is awesome.</p>
                ...
                <NavButton right="IT Technician" rightNav="/experience/stewarts" />
            </div>
        </>
    );
}
