                ...
                preview={
                    <>
                        <p>
                            ...
                            refactored numerous times to simplify future development and maintenance. On the user side,
                        ...
                        <p>
                            ...
                            minimizing duplication. As the project has grown, components have been continuously
                            refactored to improve organization and simplify future development.
                        </p>

                        <p>
                            Styling is managed through a collection of reusable CSS classes. Colors, spacing,
                            typography, and other visual elements are defined centrally to ensure consistency throughout
                            the site. This approach makes it easy to update the site's appearance without requiring
                            widespread changes across the codebase.
                        </p>

                        <p>
                            To support a wide range of screen sizes, the site utilizes a dedicated scaling system that
                            adjusts layouts, spacing, and typography responsively. Rather than treating responsiveness
                            as an afterthought, scalability was considered throughout development to provide a
                        ...
                        <p>
                            ...
                            required manually SSHing into the DigitalOcean droplet to pull changes, rebuild containers,
                            and restart services. Today, a lightweight CI/CD pipeline built with GitHub Actions paired
                            with Docker automates deployment, making new changes as simple as typing{' '}
                            <code>git push</code>.
                        </p>
                        <hr />
                        <h2>Reflection</h2>
                        <p>
                            Building this site has deepened my understanding of web technologies and dev ops while
                            providing the chance to reflect on past experiences. Through this, I have gained greater
                            confidence in who I am and what I bring to the table.
                        </p>
                    </>
                }
            />
